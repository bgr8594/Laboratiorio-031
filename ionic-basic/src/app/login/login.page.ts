...
ionicForm: FormGroup;
  ...
  ngOnInit() {
    /*
    const usuario = {nombre: 'Kenneth', activo: true, fechanaci: 0};
    ...
    this.ionicForm = this.formBuilder.group(
      {
        ...
        password: new FormControl('', {validators: [Validators.required, Validators.minLength(6), Validators.maxLength(25)]})
      }
    );
  }
